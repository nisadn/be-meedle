...
class BSBIIndex:
    ...
    def save(self):
        ...
        with open(os.path.join(STATIC_URL, self.output_dir, 'terms.dict'), 'wb') as f:
            pickle.dump(self.term_id_map, f)
        with open(os.path.join(STATIC_URL, self.output_dir, 'docs.dict'), 'wb') as f:
            pickle.dump(self.doc_id_map, f)

    def load(self):
        """Memuat doc_id_map and term_id_map dari output directory"""

        with open(os.path.join(STATIC_URL, self.output_dir, 'terms.dict'), 'rb') as f:
            self.term_id_map = pickle.load(f)
        with open(os.path.join(STATIC_URL, self.output_dir, 'docs.dict'), 'rb') as f:
    ...
    def parse_block(self, block_dir_relative):
        ...
        dir_path = os.path.join(STATIC_URL, self.data_dir, block_dir_relative)
        td_pairs = []
        for doc_name in os.listdir(dir_path):
            with open(os.path.join(STATIC_URL, dir_path, doc_name), 'r') as f:
                for line in f.readlines():
                    ...
                    for token in word_tokens:
                        ...
                        if not token.lower() in stop_words:
                            ...
                            doc_id = self.doc_id_map[os.path.join(STATIC_URL, block_dir_relative, doc_name)]
